...
class MetaHelper extends Helper {
    ...
    public function __construct(View $View, $options = []) {
        ...
        if ($this->meta['title'] === null) {
            $this->meta['title'] = __(Inflector::humanize(Inflector::underscore($this->getView()->getRequest()->getParam('controller')))) . ' - '
                . __(Inflector::humanize(Inflector::underscore($this->getView()->getRequest()->getParam('action'))));
        }
    }
    ...
    public function canonical($url = null) {
        ...
        if ($url === true) {
            $url = $this->getView()->getRequest()->here;
        } elseif (is_array($url)) {
